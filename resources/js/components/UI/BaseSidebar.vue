        ...
        <div class="px-2 py-6 md:block" :class="isOpen? 'block': 'hidden'">
            <ul>
                <li class="px-2 py-3 hover:bg-gray-900 rounded"
                    :class="route().current('dashboard.index')? 'bg-gray-900' : ''">
                    <inertia-link href="/dashboard" class="flex items-center">
                ...
                <li @click="categoryToggle" class="px-2 py-3 hover:bg-gray-900 rounded mt-2" :class="[(route().current('categories.*')? 'bg-gray-900' : ''), (route().current('subcategories.*')? 'bg-gray-900' : '')]">
                ...
                <li v-if="categoryIsOpen" class="px-2 py-3 hover:bg-gray-900 rounded mt-2"
                    :class="route().current('categories.*')? 'bg-gray-900' : ''">
                    <a href="/dashboard/categories" class="flex items-center">
                        <span class="mx-2 text-gray-300">الرئيسية</span>
                    </a>
                </li>
                <li v-if="categoryIsOpen" class="px-2 py-3 hover:bg-gray-900 rounded mt-2"
                    :class="route().current('subcategories.*')? 'bg-gray-900' : ''">
                    <a href="/dashboard/subcategories" class="flex items-center">
                        <span class="mx-2 text-gray-300">الفرعية</span>
                    </a>
                </li>
                <li class="px-2 py-3 hover:bg-gray-900 rounded mt-2" :class="route().current('products.*')? 'bg-gray-900' : ''">
                    <a href="/dashboard/products" class="flex items-center">
                        <svg class="w-6 text-gray-500" fill="none" stroke-linecap="round" stroke-linejoin="round"
                            stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                            <path
                ...
                <li class="px-2 py-3 hover:bg-gray-900 rounded mt-2" :class="route().current('deliveries.*')? 'bg-gray-900' : ''">
                    ...
                    <li class="px-2 py-3 hover:bg-gray-900 rounded mt-2"
                   >
                    <inertia-link href="/dashboard/markters" class="flex items-center">
                        <svg class="w-6 text-gray-500" fill="none" stroke-linecap="round" stroke-linejoin="round"
                            stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                            <path
                                d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z">
                        ...
                        <span class="mx-2 text-gray-300">المسوقات</span>
                    </inertia-link>
                </li>
